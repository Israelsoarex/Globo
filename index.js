...
function calAtbiotico(x,agora,diferencaDia) {
   ...
   auxData.setDate(diaBiotico + agora.getDate())
    ...
    slPara.innerText = `Do dia ${agora.getDate()-(diferencaDia*-1)} até o dia ${agora.getDate()} já se passaram-se ${diferencaDia*-1} dias. Essa receita é valida ate o dia ${auxData.getDate()}/${auxData.getMonth()}/${auxData.getFullYear()}`;
}
